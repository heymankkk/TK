...
@WebServlet("/pay_cart_pro")
public class pay_cart_pro extends HttpServlet {
	private static final long serialVersionUID = 1L;
    public pay_cart_pro() {        super();    }
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int cartordercount = DB.cartordercount();
		...
		t_data.setCartcustno(cartordercount+1);
		...
		session.invalidate();
		response.sendRedirect("IKEA_com/IKEA_COM.jsp?pageName=cart.jsp");
	}
